...
// Check file size
if ($_FILES["avatarUpload"]["size"] > 4000000) {
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["avatarUpload"]["tmp_name"], $target_file)) {
        echo "The file ". basename( $_FILES["avatarUpload"]["name"]). " has been uploaded.";
    } else {
...
if($uploadOk){
  $sqlString = "UPDATE `users` SET avatar = '$target_file' WHERE login='$username'";
